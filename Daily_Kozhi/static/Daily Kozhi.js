...
window.addEventListener('scroll', () => {
    ...
    sections.forEach(section => {
        ...
        const sectionHeight = section.clientHeight; // Fix the typo here
...
const swiper = {
    ...
    initSwiper: function () {
        this.swiperInstance = new Swiper(".home-slider", this.config);
    },
};
...
//   for wishlist
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addToWishlistBtn.addEventListener('click', function () {
            ...
            let productImage = "Images/Triple trouble burger.png";
...
// second product 
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addToWishlistBtn.addEventListener('click', function () {
            ...
            let productDescription = "arabic kuthu";
            let productPrice = "99"
            let productImage = "Images/fried chicken.png";
...
// third product
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addToWishlistBtn.addEventListener('click', function () {
            ...
            let productDescription = "thinnu paru da";
            let productPrice = "149"
            let productImage = "Images/arabic kuthu.png";
...
// fourth prodouct
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addToWishlistBtn.addEventListener('click', function () {
            ...
            let productImage = "Images/crab fry .jpg";
...
// fifth product
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addToWishlistBtn.addEventListener('click', function () {
            ...
            let productDescription = "This is a sample product description.";
            let productPrice = "99";
            let productImage = "Images/fish fry.png";
...
// sixth product
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addToWishlistBtn.addEventListener('click', function () {
            ...
            let productDescription = "This is a sample product description.";
            let productPrice = "199";
            let productImage = "Images/fried prawn.png";
...
// seventh product
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addToWishlistBtn.addEventListener('click', function () {
            ...
            let productImage = "Images/Biryani.png";
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addToWishlistBtn.addEventListener('click', function () {
        ...
        let productImage = "Images/turkey1.png";
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addToWishlistBtn.addEventListener('click', function () {
        ...
        let productDescription = "This is a sample product description.";
        let productPrice = "299";
        let productImage = "Images/Tandoori-Platter-scaled-1-768x644.jpg";
